-- Fix critical database issues for production readiness

-- 1. Create proper foreign key constraints for data integrity
ALTER TABLE bookings ADD CONSTRAINT fk_bookings_client 
  FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE CASCADE;

ALTER TABLE invoices ADD CONSTRAINT fk_invoices_client 
  FOREIGN KEY (client_id) REFERENCES invoices(id) ON DELETE CASCADE;
...
-- 2. Create automatic profile creation trigger for new users
